...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    ...
    <script>
        ...
        $.ajax({
            type: "post",
            url: "/api/recurring-slots/create",
            data: {
                start: '10:00',
                end: '12:00'
            },
            headers: {
                Authorization: `Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwOi8vMTI3LjAuMC4xOjgwMDAvYXBpL2F1dGgvbG9naW4iLCJpYXQiOjE3MzM2NTcxOTcsImV4cCI6MTczMzY2MDc5NywibmJmIjoxNzMzNjU3MTk3LCJqdGkiOiJqcjJuclAxeEpyblAyT2hOIiwic3ViIjoiMiIsInBydiI6IjIzYmQ1Yzg5NDlmNjAwYWRiMzllNzAxYzQwMDg3MmRiN2E1OTc2ZjcifQ.fWTrVjCQZIx3jL8TLdtMA4KHjz264b04w7TemAql_VE`,
